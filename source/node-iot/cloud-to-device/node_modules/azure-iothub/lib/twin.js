...
var Twin = (function () {
    ...
    Twin.prototype.get = function (done) {
        ...
        - `this.deviceId`
        - `done`]*/
        this._registry.getTwin(this.deviceId, function (err, result, response) {
            if (err) {
    ...
    Twin.prototype.update = function (patch, done) {
        ...
        - `this.etag`
        - `done`]*/
        this._registry.updateTwin(this.deviceId, patch, this.etag, function (err, result, response) {
            if (err) {
                /*Codes_SRS_NODE_IOTHUB_TWIN_16_022: [The method shall call the `done` callback with an `Error` object if the request failed]*/
                done(err);
            }
