 ...
 *
 */
var MqttTwinReceiver = (function (_super) {
    ...
    function MqttTwinReceiver(client) {
        ...
        _this._boundMessageHandler = _this._onMqttMessage.bind(_this); // need to save this so that calls to add & remove listeners can be matched by the EventEmitter.
        return _this;
    }
    MqttTwinReceiver.prototype._handleNewListener = function (eventName) {
        var self = this;
        if (eventName === MqttTwinReceiver.responseEvent) {
            if (events_1.EventEmitter.listenerCount(this, MqttTwinReceiver.responseEvent) === 0) {
            ...
            if (events_1.EventEmitter.listenerCount(this, MqttTwinReceiver.postEvent) === 0) {
                this._startListeningIfFirstSubscription();
    ...
    MqttTwinReceiver.prototype._startListeningIfFirstSubscription = function () {
        ...
        if ((events_1.EventEmitter.listenerCount(this, MqttTwinReceiver.responseEvent) === 0) && (events_1.EventEmitter.listenerCount(this, MqttTwinReceiver.postEvent) === 0)) {
    ...
    MqttTwinReceiver.prototype._stopListeningIfLastUnsubscription = function () {
        ...
        if ((events_1.EventEmitter.listenerCount(this, MqttTwinReceiver.responseEvent)) && (events_1.EventEmitter.listenerCount(this, MqttTwinReceiver.postEvent) === 0)) {
    ...
    MqttTwinReceiver.prototype._handleError = function (err) {
        ...
        this.emit(MqttTwinReceiver.errorEvent, mqtt_translate_error_1.translateError(err));
    };
