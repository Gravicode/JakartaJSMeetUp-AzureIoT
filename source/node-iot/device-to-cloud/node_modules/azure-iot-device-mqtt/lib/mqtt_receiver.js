...
var debug = dbg('device:mqtt-receiver');
 ...
 * @type {Message}
 */
var MqttReceiver = (function (_super) {
    __extends(MqttReceiver, _super);
    function MqttReceiver(mqttClient, topicMessage) {
        ...
        if (!mqttClient) {
            throw new ReferenceError('mqttClient cannot be falsy');
        }
        if (!topicMessage) {
            throw new ReferenceError('topicMessage cannot be falsy');
        }
        _this._mqttClient = mqttClient;
        ...
        _this._topics = {
            'message': {
                ...
                handler: _this._onC2DMessage.bind(_this)
            },
            'method': {
                ...
                handler: _this._onDeviceMethod.bind(_this)
            }
        };
        var self = _this;
        ...
        var dispatchMqttMessage = _this._dispatchMqttMessage.bind(_this);
...
exports.MqttReceiver = MqttReceiver;
//# sourceMappingURL=mqtt_receiver.js.map